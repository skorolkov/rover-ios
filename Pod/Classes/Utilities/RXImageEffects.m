...
@implementation RVImageEffects


+ (UIImage *)applyLightEffectToImage:(UIImage *)image
{
    UIColor *tintColor = [UIColor colorWithWhite:1.0 alpha:0.3];
    return [RVImageEffects applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil toImage:image];
}
...
+ (UIImage *)applyExtraLightEffectToImage:(UIImage *)image
{
    ...
    return [RVImageEffects applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil toImage:image];
}
...
+ (UIImage *)applyTintEffectWithColor:(UIColor *)tintColor toImage:(UIImage *)image
{
    ...
    return [RVImageEffects applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil toImage:image];
}
