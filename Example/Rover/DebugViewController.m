...
- (IBAction)simulateButtonPressed:(id)sender {
    ...
    [[Rover shared] simulateBeaconWithUUID:UUID major:18347 minor:48847 duration:122];
    
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        [[Rover shared] simulateBeaconWithUUID:UUID major:18347 minor:62298 duration:120];
    });
}
